...
# async def time(websocket, path): #while True: #print("start")## port = "/dev/tty.HC-05-SPPDev"##
# print("Connected")## data = bluetooth.readline().decode()## await websocket.send(data)
